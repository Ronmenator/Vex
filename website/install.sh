...
echo "    View a value: vex configure get llm.provider"
echo "    Set a value:  vex configure set llm.provider anthropic"
echo ""
echo -e "  ${CYAN}Telegram setup:${NC}"
echo "    1. Create a bot via @BotFather on Telegram"
echo "    2. vex configure set telegram.bot_token YOUR_TOKEN"
echo "    3. vex --telegram"
echo ""
